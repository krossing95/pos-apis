...
const GetOrganizationalSuppliers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const query = Object.assign({ organization: payload.organizationId }, utils_index_1.defaultGetQuery);
        ...
        return res.status(200).json({
            message: "",
            code: "200",
            data: { suppliers: (0, helper_index_1.parseApiResults)(results), isNext },
        });
    }
    catch (error) {
...
exports.default = GetOrganizationalSuppliers;
