...
const offsetCalculator = ({ pageNumber = 1, pageSize = 20, searchString = "", organizationId, sortBy = "desc", }) => {
    ...
    const query = Object.assign({ organization: organizationId }, utils_index_1.defaultGetQuery);
...
const GetOrganizationalCategories = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const payload = req.body;
        const { sortOptions, skipAmount, query, pageSize } = offsetCalculator(Object.assign({}, payload));
        ...
        const results = yield categoriesQuery.exec();
...
exports.default = GetOrganizationalCategories;
