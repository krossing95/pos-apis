...
const UpdateUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedUser = yield model_user_1.default.findByIdAndUpdate(payload._id, Object.assign({}, payload));
        return res
            .status(200)
            .status(200)
            .json({
            ...
            code: "200",
            data: Object.assign({}, (0, helper_index_1.parseApiResults)(updatedUser)),
        });
    }
    catch (error) {
